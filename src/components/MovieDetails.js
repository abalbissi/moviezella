...
const MovieDetails = () => {
    ...
    const getMovieDetails = async () => {
        const res = await axios.get(`https://api.themoviedb.org/3/movie/${param.id}?api_key=5bdb980a1b1ffa25a192d782abaa874e&language=ar`)
        setMovie(res.data)
    }
    useEffect(() => {
        getMovieDetails();
        ...
        <div>
            ...
            <Row className="justify-content-center">
                <Col
                    ...
                    <a href='https://x.egy-best.net/ght6/'>
                        <button
                            style={{ backgroundColor: "#b45b35", border: "none" }}
